...
export const locations: Record<LocationSlug, LocationData> = {
  "st-johns": {
    ...
    bookingLinks: [
      { name: "Rage Room", description: "The main event: a private destruction session with safety gear included.", price: "From $35", duration: "45 minutes", url: "https://bookcelticaxe.as.me/schedule/b12708f9/?categories[]=Stormbreaker%20Rage%20Room" },
      { name: "Rage + Axe Combo", description: "Start with the smash, then add axe throwing for the full experience.", price: "From $45", duration: "About 90 minutes", url: "https://bookcelticaxe.as.me/schedule/b12708f9/?categories[]=Stormbreaker%20Rage%20%2F%20Axe%20Combo" },
      { name: "Axe Throwing", description: "An optional bonus activity with professional lanes and instruction.", price: "From $25", duration: "1 hour", url: "https://bookcelticaxe.as.me/schedule/b12708f9/?categories[]=Stormbreaker%20Axe%20Throwing" },
    ],
