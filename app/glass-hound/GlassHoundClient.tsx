        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
              Partner locations keep recycling like you already do—just using our totes. We don't want to put any extra work on you. We're a no-nonsense, reliable recycling partner that's consistent, on-time, and dependable with scheduled pickups whenever you need us.
            </p>
          </div>
